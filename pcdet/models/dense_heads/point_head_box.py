...
class PointHeadBox(PointHeadTemplate):
    ...
    # def cart_to_spherical(self, coords):
        ...
        if self.model_cfg.get('USE_POINT_FEATURES_BEFORE_FUSION', False):
            ...
            if getattr(self.model_cfg, 'MULTI_VIEWS', None):
                ...
                for i in range(num_views):
                    spherical_points_features = batch_dict[f'spherical_point_features_{i}']
                    # brpt_ = self.cart_to_spherical(point_coords.float())
                    if self.model_cfg.FUSE_METHOD == 'add':
                        point_features = point_features + spherical_points_features
                    else:
